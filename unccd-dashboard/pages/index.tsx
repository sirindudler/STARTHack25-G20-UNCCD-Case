                  ...
                  <CardContent>
                    <div className="h-64 bg-gray-50 rounded-md p-4 grid grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center justify-center">
                        <div className="relative w-40 h-40">
                          {/* Clay segment - 30% */}
                          <div
                            className="absolute top-0 left-0 w-full h-full bg-brown-400 rounded-full"
                            style={{
                              clipPath:
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-green-50 p-4 rounded-md">
                        ...
                        <p className="text-2xl font-bold">4 pH</p>
                      </div>
                      <div className="bg-green-50 p-4 rounded-md">
                ...
                <Card>
                  <CardHeader>
                    <div className="flex justify-between items-center">
                      ...
                      <Badge>"Harvest Layer"</Badge>
                    </div>
                    <CardDescription>
                      Crop yields and harvest forecasts
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64 bg-gray-50 rounded-md p-6">
