...
ax.axis("off")
plt.savefig("base_map.png", dpi=300, bbox_inches="tight", transparent=True)
plt.close()
...
ax.set_ylim(assaba_bounds[1], assaba_bounds[3])
ax.axis("off")
plt.savefig("district_layer.png", dpi=300, bbox_inches="tight", transparent=True)
plt.close()
...
ax.set_ylim(assaba_bounds[1], assaba_bounds[3])
ax.axis("off")
plt.savefig("region_layer.png", dpi=300, bbox_inches="tight", transparent=True)
plt.close()
...
ax.set_ylim(assaba_bounds[1], assaba_bounds[3])
ax.axis("off")
plt.savefig("stream_layer.png", dpi=300, bbox_inches="tight", transparent=True)
plt.close()
...
ax.set_ylim(assaba_bounds[1], assaba_bounds[3])
ax.axis("off")
plt.savefig("road_layer.png", dpi=300, bbox_inches="tight", transparent=True)
plt.close()